      ...
      <section className="mx-auto flex max-w-5xl flex-col gap-10 px-6 lg:flex-row">
        <div className="lg:w-1/2">
          <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Universal Spray Console
          </h1>
          <p className="mt-4 text-base text-muted-foreground">
            Plan and execute native or ERC-20 sprays into Push Chain Donut without calling the engineering team. Upload recipients, simulate payouts, and launch campaigns with universal signatures your stakeholders can trust.
          </p>
          <div className="mt-6 grid gap-4 rounded-lg border bg-card p-4 text-sm text-card-foreground">
            ...
            <div>
              ...
              >
                Use the admin board to generate and publish it in minutes.
              </Link>
            </div>
          </div>
        </div>
